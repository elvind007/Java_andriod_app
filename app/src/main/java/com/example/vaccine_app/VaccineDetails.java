...
public class VaccineDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("VaccineDetails.java : vaccine id : " + vac_id);
        ...
        bottom.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                {
                    case R.id.faq :
                        Intent intent = new Intent(getApplicationContext(), Faq_Parent.class);
        ...
        findViewById(R.id.vaccine_details_admin_backbtn).setOnClickListener((v)->{
            Toast.makeText(this, "Child Details", Toast.LENGTH_SHORT).show();

            Intent intent = new Intent(getApplicationContext(), Child_Vaccine_Info.class);
            intent.putExtra("child_id", child_id);
            startActivity(intent);
        });
    }
